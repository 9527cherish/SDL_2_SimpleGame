...
// void PartBase::update(const std::string &actionName, const CharaDirection &direction, int deltaTime)
// {
// }

// void PartBase::reset(const std::string &actionName, const CharaDirection &direction)
// {
// }
